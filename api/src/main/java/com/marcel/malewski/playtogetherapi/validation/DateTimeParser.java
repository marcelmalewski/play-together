...
public final class DateTimeParser {
	...
	private static final DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern(TIME_FORMAT).withResolverStyle(ResolverStyle.STRICT);
	...
	public static LocalDate parseToDate(String dateAsString) {
	...
	public static LocalTime parseToTime(String timeAsString) {
